...
<head>
  ...
  <!-- endinject -->
  <!-- inject:css -->
  <link rel="stylesheet" href="{{ config('myconfig.config.server_url')  }}css/vertical-layout-light/style.css">
  <!-- endinject -->
  <link rel="shortcut icon" href="{{ config('myconfig.config.server_url')  }}images/favicon.png" />
</head>
          ...
          <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="row mt-5">
              <div class="col-12 text-center mt-xl-2">
                <a class="text-white font-weight-medium" href="{{ config('myconfig.config.server_url')  }}">Back to home</a>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">Copyright © {{ date('Y') }} All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
